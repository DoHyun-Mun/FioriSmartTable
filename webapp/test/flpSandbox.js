		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapdemosmarttabledemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdemosmarttabledemo-display": {
								"semanticObject": "comsapdemosmarttabledemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.demo.smarttabledemo",
									"url": sap.ui.require.toUrl("com/sap/demo/smarttabledemo")
								}
							}
						}
					}
